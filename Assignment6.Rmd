...
c.tree <- rpart(certified ~ forum.posts + grade + assignment, method="class", data=M1, control=rpart.control(minsplit=70,minbucket=23, cp=0))
...
```{r}
c.tree2 <- prune(c.tree, cp = 0.00081699)#.047739)
...
# Both trees are actually both identical. This is true when I prune using either CP of 1 or 2 nodes.
